...
// filtering dta based on category
...
const data=[
  ...
  function getData(){
    const catValue=document.getElementById("chooseCatgeory").value
    console.log(catValue)
    const filetredData=data.filter(x=>x.category === catValue)
    console.log(filetredData)
    displayCardsByCategory(filetredData)
  }

  function displayCardsByCategory(filData){
